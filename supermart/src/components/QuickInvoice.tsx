...
import { Plus, Trash2, FileText, Download, Loader2, AlertCircle } from 'lucide-react';
...
const Overlay = () => (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
    <div className="bg-white p-6 rounded-lg shadow-xl flex flex-col items-center gap-4 text-center">
      ...
      <h3 className="text-lg font-semibold">Generating invoice, be patient..........</h3>
...
export function QuickInvoice() {
  ...
  const handleGenerateInvoice = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(JSON.stringify(errorData) || 'Failed to generate invoice.');
      }

      // Simulate the 7-second loading time before redirecting
      setTimeout(() => {
        setShowPreview(true);
  ...
  const handleDownloadPdf = () => {
    alert("This would trigger a PDF download. Backend logic required.");
  };
